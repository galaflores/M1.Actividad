...
#
# Simulación de multiagentes como robots de limpieza reactivos que se encarguen de limpiar 
# cierto número de celdas sucias y si encuentra alguna limpia, se mueva a los siguientes 
# espacios en un numero de pasos maximo. Este recopila la información durante la ejecución y despliega los movimientos 
# realizados por los agentes, porcentaje de celdas limpias y el tiempo que se tomo para esto
#----------------------------------------------------------
import mesa
import random
